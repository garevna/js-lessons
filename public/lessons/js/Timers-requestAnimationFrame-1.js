...
//         if ( !this.staticText ) return
    ...
    resizeCanvas () {
        ...
        this.canvas.points ? this.canvas.points.forEach ( point => point.draw() ) : null;
    }
}
...
let canvas = section.appendChild (
...
canvas.onclick = function ( event ) {
    let currentText = event.target.getAttribute ( "text" )
