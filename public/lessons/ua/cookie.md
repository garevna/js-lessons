# ![ico-30 study] Данные на клиенте⟪dannie_na_klyente⟫

_______________________________________

## ![ico-25 icon] Cookie⟪Cookie⟫
...
### ![ico-20 icon] Опция expires⟪optsyya_expires⟫
...
### ![ico-20 icon] Удаление куки⟪udalenye_kuky⟫
