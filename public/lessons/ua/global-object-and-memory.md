# ![ico-35 study] Вступ. Основи⟪Introduction._Basics⟫

## ![ico-30 icon] Глобальний об'єкт⟪Global_object⟫
...
## ![ico-30 icon] Пам'ять і дані⟪Memory_and_data⟫
...
## ![ico-30 icon] Типи даних⟪Data_types⟫
