...
## ![ico-30 icon] Логічні оператори⟪Negation_operator⟫
...
### ![ico-25 icon] Оператор заперечення⟪Logical_multiplication⟫
...
### ![ico-25 icon] Логічне множення⟪Logical_addition⟫
...
### ![ico-25 icon] Логічне складання⟪lohycheskoe_slozhenye⟫
