...
## ![ico-20 icon] OOP objects and data structures

••^^Robert Martin, ‘Clean Code’:^^••
••_Objects provide behaviour and hide data<br/>Data structures provide data,<br/>but do not possess any significant behaviour_••
