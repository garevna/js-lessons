...
## ![ico-25 icon] for await ... of⟪for_await_..._of⟫
...
## ![ico-25 icon] Symbol.asyncIterator⟪Symbol.asyncIterator⟫
...
## ![ico-25 icon] Асинхронный генератор⟪asynkhronnii_henerator⟫
...
### ![ico-25 cap] Примеры асинхронного генератора⟪prymeri_asynkhronnoho_heneratora⟫
