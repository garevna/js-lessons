# ![ico-30 study] Элементы функционального программирования в JS⟪alementi_funktsyonalʹnoho_prohrammyrovanyya_v_JS⟫
...
## ![ico-25 icon] Функция-аргумент⟪funktsyya-arhument⟫
...
## ![ico-25 icon] Функция-возвращаемое значение⟪funktsyya-vozvrashchaemoe_znachenye⟫
