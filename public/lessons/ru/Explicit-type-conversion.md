...
## ![ico-25] Явное приведение типов⟪yavnoe_pryvedenye_typov⟫
...
### ![ico-20 icon] Явное приведение к ~number~⟪yavnoe_pryvedenye_k_~number~⟫
...
### ![ico-20 icon] Явное приведение к ~boolean~⟪yavnoe_pryvedenye_k_~boolean~⟫
