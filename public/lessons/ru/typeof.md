...
# ![ico-35 study] Переменные. Типы данных⟪Variables._Data_types⟫

## ![ico-30 icon] Оператор typeof⟪Operator_typeof⟫
...
## ![ico-30 icon] Спецификация ECMAScript⟪ECMAScript_Specification⟫
