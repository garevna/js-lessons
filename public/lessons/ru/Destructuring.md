# ![ico-40 icon] Деструктуризация⟪destrukturyzatsyya⟫
...
### ![ico-20 icon] Обмен значениями⟪obmen_znachenyyamy⟫
...
### ![ico-20 icon] Выборка отдельных значений из массива⟪viborka_otdelʹnikh_znachenyi_yz_massyva⟫
...
### ![ico-20 icon] Сортировка массива⟪sortyrovka_massyva⟫
...
## ![ico-25 icon] Деструктуризация глубоких структур данных⟪destrukturyzatsyya_hlubokykh_struktur_dannikh⟫
...
## ![ico-25 icon] spread и rest (...)⟪spread_y_rest_(...)⟫
...
### ![ico-20 icon] Оператор rest (...) в применении к объекту⟪operator_rest_(...)_v_prymenenyy_k_obъektu⟫
...
### ![ico-20 icon] Клонирование "плоского" массива⟪klonyrovanye__ploskoho__massyva⟫
...
### ![ico-30 icon] Other samples⟪Other_samples⟫
