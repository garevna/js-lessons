...
## ![ico-25 icon] Больше, чем просто обещание⟪More_than_just_a_promise⟫
...
### ![ico-20 icon] Диспетчер очередей⟪Queue_Manager⟫
...
### ![ico-20 icon] Организатор асинхронных процессов⟪Organiser_of_asynchronous_processes⟫
