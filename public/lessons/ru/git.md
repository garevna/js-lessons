...
## ![ico-30 icon] Подготовка к работе⟪podhotovka_k_rabote⟫
...
### ![ico-20 bash] git config⟪git_config⟫
...
### ![ico-20 bash] git branch⟪git_branch⟫
...
# ![ico-30 git] Генерация SSH-ключа⟪heneratsyya_SSH-klyucha⟫
