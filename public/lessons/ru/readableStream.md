# ![ico-30 study] Streams API⟪Streams_API⟫
...
## ![ico-25 icon] Интерфейсы Streams API⟪ynterfeisi_Streams_API⟫
...
### ![ico-20 icon] ReadableStream⟪ReadableStream⟫
