...
## ![ico-30 icon] Вызов функции⟪Function_call⟫
...
### ![ico-25 icon] Библиотека Math⟪Math_library⟫
...
## ![ico-30 icon] Объявление функции⟪Declaring_a_function⟫
...
## ![ico-30 icon] Формальные параметры⟪Formal_parameters⟫
...
### ![ico-25 icon] Дефолтные значения⟪Default_values⟫
