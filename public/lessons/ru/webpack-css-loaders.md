# ![ico-70 node] module.exports & require()⟪module.exports_&_require⟫

В  **Node.js** собственная система модулей

Все скрипты в **Node.js** должны быть **модулями**

## ![ico-25 icon] Создание модулей⟪sozdanye_modulei⟫
...
## ![ico-25 icon] Подключение модулей⟪podklyuchenye_modulei⟫
...
# ![ico-30 webpack] webpack.config.js⟪webpack.config.js⟫
...
## ![ico-25 webpack] Loaders⟪Loaders⟫
...
### ![ico-20 webpack] Подключение css-модулей⟪podklyuchenye_css-modulei⟫
...
## ![ico-25 webpack] Упражнение 5⟪Exercise_5⟫
...
### ![ico-20 webpack] Установка загрузчиков⟪ustanovka_zahruzchykov⟫
