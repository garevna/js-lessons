...
![ico-25 warn] Після встановлення ~breakpoints~ потрібно перезавантажити сторінку ![reload].

![](illustrations/lesson-01-debugger.gif)

_______________________________________________________

![ico20] Можна відстежувати зміну значень змінних ще й у розділі **~Scope~** відладчика:
...
У  **Chrome DevTools**  можна також призупиняти виконання коду, коли відбуваються події DOM
