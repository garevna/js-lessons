...
## ![ico-30 icon] Виклик функції⟪Function_call⟫
...
### ![ico-25 icon] Бібліотека Math⟪Math_library⟫
...
## ![ico-30 icon] Оголошення функції⟪Declaring_a_function⟫
...
В іншому разі буде згенеровано виняток **TypeError**:
...
## ![ico-30 icon] Формальні параметри⟪Formal_parameters⟫
...
Давайте розберемося, як визначається це значення.

### ![ico-25 icon] Дефолтні значення⟪Default_values⟫
...
## ![ico-30 icon] Оператор return⟪Return_operator⟫
