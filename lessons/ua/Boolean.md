# ![ico-35 study] Логічні конструкції JS⟪Logical_language_constructs⟫

У цьому розділі ми познайомимося з логічними значеннями, логічними змінними, логічними виразами та логічними операторами.

## ![ico-30 icon] Змінні логічного типу (boolean)⟪Variables_of_logical_type_(boolean)⟫
...
Значення, які може набувати ця змінна, - «істина» (**_true_**) або «брехня» (**_false_**).
••••

![ico-25 pin] **~true~** і **~false~** - це **логічні значення**.
...
## ![ico-30 icon] Логічні вирази⟪Logical_expressions⟫
...
Змінна **~appleIsRedAndRound~** приймає значення **~true~**, коли властивість **~apple.color~** має значення “red”, а властивість **~apple.shape~** має значення “round”.
...
### ![ico-25 icon] Оператори порівняння⟪Comparison_operators⟫
...
Якщо перші символи рядків-операндів збігаються, то порівнюються наступні символи, і так доти, доки один із символів не виявиться більшим або меншим за другий.
...
## ![ico-30 icon] Логічні оператори⟪Logical_operators⟫
...
### ![ico-25 icon] Оператор заперечення⟪Negation_operator⟫
...
### ![ico-25 icon] Логічне множення⟪Logical_multiplication⟫
...
### ![ico-25 icon] Логічне складання⟪Logical_addition⟫
