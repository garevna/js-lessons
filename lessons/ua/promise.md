...
## ![ico-30 icon] Контекст виклику⟪Call_context⟫
...
### ![ico-25 icon] Екземпляр⟪Instance⟫
...
### ![ico-25 icon] Статичні методи⟪Static_methods⟫
...
### ![ico-25 icon] Прототипні методи⟪Prototypal_methods⟫
