# ![ico-35 study] Итерирующие методы массивов⟪Array_iterating_methods⟫
...
### ![ico-25 icon] Контекст вызова функции-аргумента⟪Function-argument_call_context⟫
...
### ![ico-20 icon] Примеры с методом forEach⟪Examples_with_the_~map~_method⟫
...
### ![ico-20 icon] Примеры с методом `map`⟪Examples_using_the_-map-_method⟫
...
### ![ico-20 icon] Примеры с методом reduce()⟪Examples_using_the_reduce_method⟫
...
## ![ico-30 icon] Примеры и тесты⟪Examples_and_tests⟫

_________________________________________

### ![ico-25 cap] Сумма кеша на картах⟪Cache_amount_on_cards⟫
...
### ![ico-25 cap] Чистка от дублей⟪Clearing_duplicates⟫
...
### ![ico-25 cap] Число отрезков в интервале⟪Number_of_nested_segments⟫
...
### ![ico-25 cap] Проверка парных скобок⟪Checking_paired_brackets⟫
