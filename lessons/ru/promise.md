...
## ![ico-30 icon] Конструктор⟪Call_context⟫
...
### ![ico-25 icon] Функция-аргумент⟪Instance⟫
...
### ![ico-25 icon] Экземпляр⟪Static_methods⟫
...
### ![ico-25 icon] Статические методы⟪Prototypal_methods⟫
...
### ![ico-25 icon] Прототипные методы⟪catch⟫
...
## ![ico-30 icon] Магическая коробка⟪then⟫
...
## ![ico-25 icon] "Пакеты" промисов⟪finally⟫
