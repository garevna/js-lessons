# ![ico-30 study] Базы данных NoSQL⟪bazi_dannikh_NoSQL⟫
...
## ![ico-25 icon] Модели данных⟪modely_dannikh⟫
...
### ![ico-20 icon] Key / value⟪Key_/_value⟫
...
### ![ico-20 icon] Document store⟪Document_store⟫
...
### ![ico-20 icon] Множественные запросы⟪mnozhestvennie_zaprosi⟫
...
### ![ico-20 icon] Кэширование, репликация и денормализация⟪kashyrovanye,_replykatsyya_y_denormalyzatsyya⟫
...
### ![ico-20 icon]  Вложенные данные⟪vlozhennie_dannie⟫
...
## ![ico-25 icon] Принципы ACID⟪pryntsypi_ACID⟫
...
### ![ico-25 green-ok] Atomicity⟪Atomicity⟫
...
### ![ico-25 green-ok] Consistency⟪Consistency⟫
...
### ![ico-25 green-ok] Isolation⟪Isolation⟫

**Изолированность**

Во время выполнения транзакции параллельные транзакции не должны оказывать влияния на её результат

### ![ico-25 green-ok] Durability⟪Durability⟫
