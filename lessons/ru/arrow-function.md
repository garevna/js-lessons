# ![ico-30 study] Стрелочные функции⟪Arrow_functions⟫
...
## ![ico-25 icon] Главные особенности стрелочных функций⟪Key_features_of_arrow_functions⟫
...
### ![ico-20 icon] Контекст вызова⟪prototype⟫
...
#### ![ico-20 icon] Литерал объекта⟪Object_literal⟫
...
----------------
#### ![ico-20 icon] Конструктор⟪Call_context⟫
