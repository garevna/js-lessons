# ![ico-30 study] Объект function⟪The_function_object⟫
...
## ![ico-25 icon] Объект arguments⟪The_arguments_object⟫
...
## ![ico-25 icon] Вызываемый объект⟪The_calling_object⟫
...
### ![ico-20 icon] Ссылка на контекст вызова⟪Reference_to_the_call_context⟫
...
## ![ico-25 icon] Контекст исполнения⟪Execution_context⟫
...
### ![ico-20 icon] Область видимости⟪Scope⟫
...
## [![ico-30 hw] Упражнения](test/functionObject)⟪Exercises⟫
