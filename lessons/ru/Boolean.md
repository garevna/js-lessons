# ![ico-35 study] Логические конструкции языка⟪Logical_language_constructs⟫
...
## ![ico-30 icon] Переменные логического типа (boolean)⟪Variables_of_logical_type_(boolean)⟫
...
Значения, которые может принимать эта переменная - "истина" (**_true_**) или "ложь" (**_false_**).
••••

![ico-25 pin] **~true~** и **~false~** - это **логические значения**.
...
## ![ico-30 icon] Логические выражения⟪Logical_expressions⟫
...
### ![ico-25 icon] Операторы сравнения⟪Comparison_operators⟫
...
## ![ico-30 icon] Логические операторы⟪Logical_operators⟫
...
### ![ico-25 icon] Оператор отрицания⟪Negation_operator⟫
...
### ![ico-25 icon] Логическое умножение⟪Logical_multiplication⟫
...
### ![ico-25 icon] Логическое сложение⟪Logical_addition⟫
