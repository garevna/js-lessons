...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   eng: () => (/* binding */ eng)\n/* harmony export */ });\nvar eng = ['404', 'API', 'Array-iterating-methods-theory', 'Array-iterating-methods', 'arrayBuffer', 'arrow-function', 'async-await', 'async-is-good', 'Block-diagram', 'Boolean', 'Chrome-dev-tools', 'data-structures', 'dynamic-import', 'Event-Loop', 'for', 'function', 'JSON', 'pattern-Observer', 'pattern-Strategy', 'promise', 'start-page', 'Timers', 'var', 'while'];\n\n//# sourceURL=webpack://content-worker/./src/configs/eng.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   js: () => (/* binding */ js)\n/* harmony export */ });\nvar js = ['Array-iteration-methods-1', 'Array-iteration-methods-2', 'Array-iteration-methods-3', 'Array-iteration-methods-brackets', 'Array-iteration-methods-reduce-1', 'Array-iteration-methods-reduce-10', 'Array-iteration-methods-reduce-2', 'Array-iteration-methods-reduce-3', 'Array-iteration-methods-reduce-4', 'Array-iteration-methods-reduce-5', 'Array-iteration-methods-reduce-7', 'Array-iteration-methods-theory', 'async-await-01', 'async-await-02', 'async-await-03', 'async-await-05', 'async-await-10', 'async-await-11', 'async-await-13', 'async-await-16', 'async-await-6', 'async-await-9', 'async-is-good-1', 'async-is-good-3-1', 'async-is-good-3-2', 'async-is-good-4', 'async-is-good-5', 'BOM-geolocation', 'Date-constructor-1', 'Date-constructor', 'DOM-events-1', 'DOM-events-2', 'DOM-events-3', 'DOM-events', 'DOM-MutationObserver-1', 'dynamic-import-1', 'dynamic-import-3', 'event-loop-01', 'Event-Loop-1', 'Event-Loop-3', 'Event-Loop-4', 'Event-Loop-6', 'event-loop-microtask', 'functionality-1', 'functionality', 'functionality', 'generators-1', 'generators-11-1', 'generators-11', 'generators-12', 'generators-13', 'generators-17', 'generators-18', 'generators-23', 'generators-24', 'generators-26', 'generators-3', 'generators-4-1', 'generators-4', 'generators-5', 'generators-7', 'generators-8', 'generators-9', 'get-and-set-calculator', 'get-and-set-price', 'Implicit-type-conversion', 'Notification-with-worker-1', 'Notification-worker-1', 'offset-height', 'offset-left', 'pattern-1', 'pattern-observer-1', 'pattern-observer', 'pattern-strategy', 'promise-03', 'promise-04', 'promise-12', 'promise-all-01', 'promise-all-settled-01', 'promise-arrays-01', 'promise-arrays-02', 'promise-race', 'promise', 'requestAnimationFrame-4', 'requestAnimationFrame-5', 'requestAnimationFrame-6', 'REST-endpoints-1', 'REST-endpoints', 'scroll-1', 'testESModules', 'throttling-and-debouncing-1', 'throttling-and-debouncing-2', 'Timers-10', 'Timers-3', 'Timers-4', 'Timers-5', 'Timers-6', 'Timers-7', 'Timers-requestAnimationFrame-1', 'Timers-requestAnimationFrame-2', 'Timers-requestAnimationFrame', 'Timers-setInterval', 'vars-01', 'vars-binary-bad', 'vars-binary', 'vars-char', 'vars-color', 'vars-number-1', 'vars-number-4', 'vars-number-exponential-1', 'vars-number-exponential-2', 'vars-number-infinity', 'web-component-samples', 'web-worker-1', 'web-worker-2', 'web-worker-3', 'web-worker-sample-1', 'web-worker-sample-2', 'web-worker-sample-3', 'web-workers-clone', 'webpack-es-modules-1', 'XMLHttpRequest'];\n\n//# sourceURL=webpack://content-worker/./src/configs/js.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   translations: () => (/* binding */ translations)\n/* harmony export */ });\nvar _translations;\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nvar translations = (_translations = {\n  algorithm: 'алгоритм',\n  fibonacci: 'фибоначчи',\n  sequence: 'ряд',\n  flowchart: 'блок-схема',\n  'flowchart of the algorithm': 'блок-схема алгоритма',\n  developer: 'разработчик',\n  tools: 'инструменты',\n  'developer tools': 'инструменты разработчика',\n  console: 'консоль',\n  browser: 'браузер'\n}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"sequence\", 'последовательность'), \"branching\", 'ветвление'), \"loop\", 'цикл'), \"cycle\", 'цикл'), 'loop variable', 'переменная цикла'), \"counter\", 'счетчик'), \"condition\", 'условие'), \"variable\", 'переменная'), 'data types', 'типы данных'), \"function\", 'функция'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"array\", 'массив'), \"element\", 'элемент'), \"object\", 'объект'), \"number\", 'число'), \"string\", 'строка'), \"boolean\", 'логическое значение'), \"typing\", 'типизация'), 'dynamic typing', 'динамическая типизация'), \"literal\", 'литерал'), \"value\", 'значение'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'primitive value', 'примитивное значение'), \"calculated\", 'вычисляемый'), \"assignment\", 'присваивание'), 'arithmetic operations', 'арифметические операции'), \"increment\", 'инкремент'), \"decrement\", 'декремент'), 'prefix form', 'префиксная форма'), 'postfix form', 'пост-префиксная форма'), \"operator\", 'оператор'), \"operand\", 'операнд'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"concatenation\", 'конкатенация'), 'comparison operator', 'оператор сравнения'), 'logical operations', 'логические операции'), 'logical expression', 'логическое выражение'), 'conditional operator', 'условный оператор'), 'ternary operator', 'тернарный оператор'), 'loop operator', 'оператор цикла'), 'strict equality', 'строгое равенство'), 'functional expression', 'функциональное выражение'), 'linked list', 'связные списки'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"selector\", 'селектор'), \"shadow\", 'тень'), \"custom\", 'кастомный'), 'type coercion', 'приведение типов'), 'Explicit type coercion', ''), 'Implicit type coercion', ''), 'bitwise operations', 'битовые операции'), \"remainder\", 'остаток от деления'), 'string methods', 'методы строк'), 'array methods', 'методы массивов'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'function declaration', 'объявление функции'), 'function expression', 'функциональное выражение'), \"parameters\", 'параметры'), \"arguments\", 'аргументы'), 'formal parameters', 'формальные параметры'), 'default parameter values', 'дефолтные значения параметров'), \"call\", 'вызов'), 'function call', 'вызов функции'), \"context\", 'контекст'), 'call context', 'контекст вызова'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'execution context', 'контекст исполнения'), \"scope\", 'область видимости'), 'scope chain', 'цепочка областей видимости'), 'global object', 'глобальный объект'), \"symbol\", 'символ'), \"global\", 'глобальный'), \"registry\", 'реестр'), \"pattern\", 'паттерн'), \"template\", 'шаблон'), \"default\", 'дефолтный'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'encoding table', 'кодировочная таблица'), 'character code', 'код символа'), 'variables in a literal', 'переменные в литерале'), 'multiline text', 'многострочный текст'), 'code injection', 'инъекции кода'), 'iteration protocol', 'протокол итерирования'), \"iteration\", 'итерирование'), \"iterable\", 'итерабельный'), \"iterator\", 'итератор'), \"traversal\", 'перебор'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"structure\", 'структура'), 'data structure', 'структурa данных'), 'data structure depth', 'глубина структуры данных'), 'deep copy', 'глубокое копирование'), \"constructor\", 'конструктор'), \"instance\", 'экземпляр'), \"property\", 'свойство'), \"descriptor\", 'дескриптор'), 'native objects', 'нативные объекты'), 'host objects', 'хост-объекты'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'object literal', 'литерал объекта'), 'arrow function', 'стрелочная функция'), \"encapsulation\", 'инкапсуляция'), \"reference\", 'ссылка'), \"inherited\", 'унаследованный'), \"own\", 'собственный'), \"public\", 'публичный'), \"private\", 'приватный'), \"computed\", 'вычисляемый'), \"getter\", 'геттер'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"setter\", 'сеттер'), 'own property', 'собственное свойство'), 'inherited property', 'унаследованное свойство'), 'private property', 'приватное свойство'), 'public property', 'публичное свойство'), 'computed properties', 'вычисляемые свойства'), \"prototype\", 'прототип'), 'prototype chain', 'цепочка прототипов'), \"enumerable\", 'перечислимое'), 'non-enumerable', 'неперечислимое'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"delegation\", 'делегирование'), \"design\", 'проектирование'), \"strategy\", 'стратегия'), \"OOP\", 'ООП'), \"inheritance\", 'наследование'), \"polymorphism\", 'полиморфизм'), 'factory method', 'фабричный метод'), \"factory\", 'фабрика'), \"pattern\", 'паттерн'), \"currying\", 'каррирование'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"binding\", 'биндинг'), 'changing the call context', 'изменение контекста вызова'), 'context switching', 'изменение контекста'), \"decorator\", 'декоратор'), 'gang of four', 'банда четырех'), 'technical specifications', 'ТЗ'), \"ts\", 'ТЗ'), \"project\", 'проект'), \"descendants\", 'потомки'), \"parent\", 'родитель'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"collection\", 'коллекция'), \"insertion\", 'вставка'), \"removal\", 'удаление'), \"tree\", 'дерево'), \"content\", 'контент'), \"example\", 'пример'), 'drop-down list', 'выпадающий список'), \"switches\", 'переключатели'), \"closure\", 'замыкание'), \"recursion\", 'рекурсия'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"recursive\", 'рекурсивная'), 'tail recursion', 'хвостовая рекурсия'), 'recursion depth', 'глубина рекурсии'), 'recursion termination condition', 'условие прерывания рекурсии'), 'call stack', 'стек вызовов'), 'event-driven programming', 'событийно-ориентированное программирование'), 'event loop', 'цикл событий'), \"event\", 'событие'), \"thread\", 'поток'), \"process\", 'процесс'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"heap\", 'куча'), \"asynchrony\", 'асинхронность'), \"callback\", 'обратный вызов'), \"microtask\", 'микротаск'), 'task queue', 'очередь задач'), 'event queue', 'очередь событий'), \"multithreading\", 'многопоточность'), 'single-threading', 'однопоточность'), 'parallel thread', 'параллельный поток'), \"core\", 'ядро'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"processor\", 'процессор'), \"engine\", 'движок'), \"promise\", 'промис'), 'asynchronous function', 'асинхронная функция'), \"domen\", 'домен'), 'cross domain', 'кросс-доменный'), 'expiration date', 'срок годности'), \"proxy\", 'прокси'), \"accessor\", 'аксессор'), \"transformation\", 'преобразование'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'page refresh rate', 'частота обновления страницы'), \"timer\", 'таймер'), \"signature\", 'сигнатура'), \"mutation\", 'мутации'), \"observer\", 'обозреватель'), \"options\", 'опции'), \"server\", 'сервер'), \"header\", 'заголовок'), \"remote\", 'удаленный'), \"soket\", 'сокет'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"repository\", 'репозиторий'), \"repo\", 'репозиторий'), \"principle\", 'принцип'), \"hash\", 'хеш'), \"digest\", 'дайджест'), 'digital signature', 'цифровая подпись'), 'functional programming', 'функциональное программирование'), 'func stuff', 'функциональщина'), 'functional vibes', 'функциональщина'), 'higher-order function', 'функция высшего порядка'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'function as argument', 'функция-аргумент'), 'function as return value', 'функция-возвращаемое значение'), 'self-invocation', 'самовызов'), \"immutability\", 'иммутабельность'), \"logging\", 'логирование'), 'temporal dead zone', 'временная \"мёртвая зона\"'), \"initialization\", 'инициализация'), 'block scope', 'блочная область видимости'), 'functional scope', 'функциональная область видимости'), \"hoisting\", 'поднятие'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"exception\", 'исключение'), \"request\", 'запрос'), \"response\", 'ответ'), \"connect\", 'соединяться'), \"connection\", 'соединение'), \"service\", 'сервис'), \"protocol\", 'протокол'), \"interface\", 'интерфейс'), \"resource\", 'ресурс'), \"operation\", 'операция'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"hook\", 'хук'), \"database\", 'база данных'), \"transaction\", 'транзакция'), \"relational\", 'реляционный'), \"tables\", 'таблицы'), \"normalization\", 'нормализация'), \"denormalization\", 'денормализация'), 'distributed system', 'распределённая система'), \"document\", 'документ'), \"graph\", 'граф'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"replication\", 'репликация'), \"scrolling\", 'прокрутка'), \"coordinates\", 'координаты'), \"width\", 'ширина'), \"height\", 'высота'), \"class\", 'класс'), 'strict mode', 'строгий режим'), \"octal\", 'восьмеричный'), \"syntax\", 'синтаксис'), \"short\", 'краткий'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"declaration\", 'объявление'), \"directive\", 'директива'), \"application\", 'приложение'), \"spoiler\", 'spoiler'), \"slider\", 'слайдер'), 'drop-down menu', 'выпадающее меню'), 'drop-down', 'выпадающее'), \"data\", 'данные'), \"client\", 'клиент'), 'save on the client', 'сохранить на клиенте'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, 'store on the client', 'сохранить на клиенте'), \"clear\", 'очистить'), \"save\", 'сохранить'), \"store\", 'сохранить'), \"add\", 'добавить'), \"append\", 'добавить'), \"delete\", 'удалить'), \"remove\", 'удалить'), \"page\", 'страница'), \"layout\", 'разметка страницы'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"markup\", 'шаблон разметки страницы'), \"fragment\", 'фрагмент'), \"attribute\", 'атрибут'), \"key\", 'ключ'), \"local\", 'локальный'), \"text\", 'текст'), \"upload\", 'загрузить'), \"download\", 'скачать'), 'uploading a file to the server', 'загрузка файла на сервер'), \"dump\", 'дамп'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"status\", 'состояние'), \"chat\", 'чат'), \"destructuring\", 'деструктуризация'), 'destructuring assignment', 'деструктурирующее присваивание'), \"rest\", 'остаток'), \"generator\", 'генератор'), \"iterator\", 'итератор'), \"asynchronous\", 'асинхронный'), 'asynchronous generators', 'асинхронный генератор'), \"indexing\", 'индексация'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"index\", 'индекс'), 'package manager', 'пакетный менеджер'), 'command line', ''), \"interpreter\", 'интерпретатор'), \"symlink\", 'символическая ссылка'), \"integrity\", 'целостность'), \"version\", 'версия'), \"ver\", 'версия'), \"dependency\", 'зависимость'), \"dependencies\", 'зависимости'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"file\", 'файл'), 'file type', 'тип файла'), 'file size', 'размер файла'), \"font\", 'шрифт'), \"embedding\", 'встраивание'), \"named\", 'именованный'), 'named export', 'именованный экспорт'), 'web component', 'веб-компонент'), \"component\", 'компонент'), \"slot\", 'слот'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"package\", 'пакет'), \"path\", 'путь'), \"port\", 'порт'), \"datagram\", 'дейтаграмма'), 'font embedding', 'подключение шрифтов'), 'command-line utility', 'утилита командной строки'), \"module\", 'модуль'), \"build\", 'сборка'), \"builder\", 'сборщик'), \"bundle\", 'бандл'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"config\", 'конфигурация'), \"import\", 'импорт'), \"export\", 'экспорт'), 'dynamic import', 'динамический импорт'), \"deployment\", 'развертывание'), \"snapshot\", 'слепок'), \"install\", 'установить'), \"installation\", 'установка'), \"caching\", 'кэширование'), \"debouncing\", 'устранение дребезга'), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_translations, \"throttling\", 'дросселирование'), \"performance\", 'производительность'), \"memory\", 'память'), \"notification\", 'уведомление'), \"desktop\", 'рабочий стол'), \"user\", 'пользователь'), \"storage\", 'хранилище'), \"game\", 'игра'), 'characters', 'персонажи'), \"insert\", 'вставить'), _defineProperty(_translations, \"registration\", 'регистрация'));\n\n//# sourceURL=webpack://content-worker/./src/configs/translations.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   ua: () => (/* binding */ ua)\n/* harmony export */ });\nvar ua = ['404', 'API', 'Array-iterating-methods-theory', 'Array-iterating-methods', 'arrayBuffer', 'arrow-function', 'async-await', 'async-is-good', 'Block-diagram', 'Boolean', 'Chrome-dev-tools', 'data-structures', 'dynamic-import', 'Event-Loop', 'for', 'function', 'JSON', 'pattern-Observer', 'pattern-Strategy', 'promise', 'start-page', 'Timers', 'var', 'while'];\n\n//# sourceURL=webpack://content-worker/./src/configs/ua.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   engChars: () => (/* binding */ engChars)\n/* harmony export */ });\nfunction engChars(string) {\n  return string.split('').filter(function (_char) {\n    return _char.charCodeAt(0) >= 97 && _char.charCodeAt(0) <= 122;\n  }).length;\n}\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/engChars.js?");

/***/ }),

/***/ "./src/helpers/search-helpers/index.js":
/*!*********************************************!*\
  !*** ./src/helpers/search-helpers/index.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nfunction _typeof(o) { \"@babel/helpers - typeof\"; return _typeof = \"function\" == typeof Symbol && \"symbol\" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && \"function\" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? \"symbol\" : typeof o; }, _typeof(o); }\nfunction _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }\nfunction _toPropertyKey(t) { var i = _toPrimitive(t, \"string\"); return \"symbol\" == _typeof(i) ? i : i + \"\"; }\nfunction _toPrimitive(t, r) { if (\"object\" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || \"default\"); if (\"object\" != _typeof(i)) return i; throw new TypeError(\"@@toPrimitive must return a primitive value.\"); } return (\"string\" === r ? String : Number)(t); }\nfunction _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\nfunction _unsupportedIterableToArray(r, a) { if (r) { if (\"string\" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return \"Object\" === t && r.constructor && (t = r.constructor.name), \"Map\" === t || \"Set\" === t ? Array.from(r) : \"Arguments\" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }\nfunction _iterableToArray(r) { if (\"undefined\" != typeof Symbol && null != r[Symbol.iterator] || null != r[\"@@iterator\"]) return Array.from(r); }\nfunction _arrayWithoutHoles(r) { if (Array.isArray(r)) return _arrayLikeToArray(r); }\nfunction _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }\nvar context = __webpack_require__(\"./src/helpers/search-helpers sync ^\\\\.\\\\/.*$\");\nvar moduleNames = context.keys().filter(function (key) {\n  return key !== './' && key !== './index' && key !== './index.js';\n});\nvar modules = Object.assign.apply(Object, [{}].concat(_toConsumableArray(moduleNames.map(function (name) {\n  return _defineProperty({}, name.split('./').join('').split('.js').join(''), context(name));\n}))));\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Object.assign.apply(Object, [{}].concat(_toConsumableArray(Object.keys(modules).map(function (key) {\n  return _defineProperty({}, key, modules[key][key]);\n})))));\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/index.js?");

/***/ }),

/***/ "./src/helpers/search-helpers/ruChars.js":
/*!***********************************************!*\
  !*** ./src/helpers/search-helpers/ruChars.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   ruChars: () => (/* binding */ ruChars)\n/* harmony export */ });\nfunction ruChars(string) {\n  return string.split('').filter(function (_char) {\n    return _char.charCodeAt(0) >= 1072 && _char.charCodeAt(0) <= 1103;\n  }).length;\n}\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/ruChars.js?");

/***/ }),

/***/ "./src/helpers/search-helpers/translate.js":
/*!*************************************************!*\
  !*** ./src/helpers/search-helpers/translate.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   translate: () => (/* binding */ translate)\n/* harmony export */ });\n/* harmony import */ var _ruChars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ruChars */ \"./src/helpers/search-helpers/ruChars.js\");\n\nvar translations = (__webpack_require__(/*! ../../configs */ \"./src/configs/index.js\")[\"default\"]).translations;\nfunction translate(string) {\n  var translated = (0,_ruChars__WEBPACK_IMPORTED_MODULE_0__.ruChars)(string) > 0 ? Object.keys(translations).find(function (key) {\n    return translations[key].includes(string);\n  }) : string;\n  return translated;\n}\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/translate.js?");

/***/ }),

/***/ "./src/helpers/search-helpers/uaChars.js":
/*!***********************************************!*\
  !*** ./src/helpers/search-helpers/uaChars.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   uaChars: () => (/* binding */ uaChars)\n/* harmony export */ });\nfunction uaChars(string) {\n  return ruChars(string) + string.split('').filter(function (_char) {\n    return ['ґ', 'є', 'ї', 'і'].includes(_char);\n  }).length;\n}\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/uaChars.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   search: () => (/* binding */ search)\n/* harmony export */ });\n/* harmony import */ var _getMainMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getMainMenu */ \"./src/helpers/getMainMenu.js\");\n\nvar translate = (__webpack_require__(/*! ./search-helpers */ \"./src/helpers/search-helpers/index.js\")[\"default\"]).translate;\nvar keywords = (__webpack_require__(/*! ../assets */ \"./src/assets/index.js\")[\"default\"]).keywords;\nfunction search(searchValue) {\n  var mainMenu = (0,_getMainMenu__WEBPACK_IMPORTED_MODULE_0__.getMainMenu)();\n  if (!searchValue) return self.postMessage({\n    route: 'main-menu',\n    response: (0,_getMainMenu__WEBPACK_IMPORTED_MODULE_0__.getMainMenu)()\n  });\n  var options = Object.keys(keywords).filter(function (key) {\n    return keywords[key].filter(function (keyword) {\n      return keyword.includes(searchValue);\n    }).length;\n  });\n  var response = mainMenu.map(function (lesson) {\n    return Object.assign(lesson, {\n      items: lesson.items.filter(function (item) {\n        return options.includes(item.ref);\n      })\n    });\n  }).filter(function (lesson) {\n    return lesson.items.length;\n  });\n  self.postMessage({\n    route: 'main-menu',\n    response: response\n  });\n}\n\n//# sourceURL=webpack://content-worker/./src/helpers/search.js?");
...
eval("var map = {\n\t\"./\": \"./src/configs/index.js\",\n\t\"./eng\": \"./src/configs/eng.js\",\n\t\"./eng.js\": \"./src/configs/eng.js\",\n\t\"./index\": \"./src/configs/index.js\",\n\t\"./index.js\": \"./src/configs/index.js\",\n\t\"./js\": \"./src/configs/js.js\",\n\t\"./js.js\": \"./src/configs/js.js\",\n\t\"./pages\": \"./src/configs/pages.js\",\n\t\"./pages.js\": \"./src/configs/pages.js\",\n\t\"./ru\": \"./src/configs/ru.js\",\n\t\"./ru.js\": \"./src/configs/ru.js\",\n\t\"./translations\": \"./src/configs/translations.js\",\n\t\"./translations.js\": \"./src/configs/translations.js\",\n\t\"./ua\": \"./src/configs/ua.js\",\n\t\"./ua.js\": \"./src/configs/ua.js\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./src/configs sync ^\\\\.\\\\/.*$\";\n\n//# sourceURL=webpack://content-worker/./src/configs/_sync_nonrecursive_^\\.\\/.*$?");

/***/ }),

/***/ "./src/helpers/search-helpers sync ^\\.\\/.*$":
/*!****************************************************************!*\
  !*** ./src/helpers/search-helpers/ sync nonrecursive ^\.\/.*$ ***!
  \****************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("var map = {\n\t\"./\": \"./src/helpers/search-helpers/index.js\",\n\t\"./engChars\": \"./src/helpers/search-helpers/engChars.js\",\n\t\"./engChars.js\": \"./src/helpers/search-helpers/engChars.js\",\n\t\"./index\": \"./src/helpers/search-helpers/index.js\",\n\t\"./index.js\": \"./src/helpers/search-helpers/index.js\",\n\t\"./ruChars\": \"./src/helpers/search-helpers/ruChars.js\",\n\t\"./ruChars.js\": \"./src/helpers/search-helpers/ruChars.js\",\n\t\"./translate\": \"./src/helpers/search-helpers/translate.js\",\n\t\"./translate.js\": \"./src/helpers/search-helpers/translate.js\",\n\t\"./uaChars\": \"./src/helpers/search-helpers/uaChars.js\",\n\t\"./uaChars.js\": \"./src/helpers/search-helpers/uaChars.js\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./src/helpers/search-helpers sync ^\\\\.\\\\/.*$\";\n\n//# sourceURL=webpack://content-worker/./src/helpers/search-helpers/_sync_nonrecursive_^\\.\\/.*$?");
