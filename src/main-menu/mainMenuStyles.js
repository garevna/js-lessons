...
import { folder_outline } from './icons/folder_outline'
import { folder_open } from './icons/folder_open'
import { folder_open_active } from './icons/folder_open_active'
...
.main-menu-wrapper {
  ...
  z-index: 55;
  background: url(${createPath('images', 'stars-in-line.gif')}), var(--header-back-color);
...
.lesson-menu-item {
  padding: 8px 24px;
  background-image: url(${folder_outline});
...
.lesson-menu-item--expanded {
  padding: 8px 28px;
  color: #fa0;
  background-image: url(${folder_open});
  background-size: 16px;
}
...
.lesson-menu-item--active--expanded {
  padding: 8px 28px;
  color: #fff;
  background-image: url(${folder_open_active});
...
//   })
//
//   worker.postMessage({ route: 'main-menu' })
// })
