export const keywords = {
  ...
  'throttling-and-debouncing': ['throttling', 'debouncing', 'debounce', 'throttle', 'performance'],
  ...
  scroll: ['scrollHeight', 'scrollWidth', 'clientHeight', 'clientWidth', 'offsetHeight', 'offsetWidth', 'scrollTop', 'scrollLeft', 'element', 'size', 'scrolling', 'scroll', 'getboundingclientrect', 'dom', 'top', 'left', 'bottom', 'right', 'width', 'height', 'coordinates', 'прокрутка', 'скроллинг', 'скролінг', 'скрол', 'scrol'],
  ...
  Set: ['set', 'constructor', 'unique', 'конструктор', 'object', 'iterable', 'ітерабельний', 'итерабельный'],
  ...
  'global-object-and-memory': ['window', 'null', 'undefined'],
  'variable-declaration': ['var', 'window', 'number', 'undefined', 'name'],
  'start-page': ['JS', 'OOP'],
  'Array-iterating-methods-theory': ['prototype', 'push', 'Math.sqrt', 'Array'],
}
